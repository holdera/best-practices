  ...
  return (
    <Layout>
      ...
      <div css={divContainer}>
        ...
        <Paragraphs>I highly recommend using Styled Components. It's easier to read and understand. The code itself looks cleaner and less convoluted. Our goal is that any dev can look at the code and quickly understand how to make updates and changes.</Paragraphs>

        <Heading3>Resources</Heading3>

        <ul css={ulList}>
          {/* <li><Anchor>Twin Macro</Anchor></li> */}
          <li><AnchorLink href='https://github.com/ben-rogerson/twin.macro' target='_blank'>Twin Macro</AnchorLink></li>
          <li><AnchorLink href='https://tailwindcss.com/' target='_blank'>TailwindCss</AnchorLink></li>
          <li><AnchorLink href='https://bendyworks.com/blog/refactoring-tailwind-css-react-with-twin-macro#:~:text=our%20React%20components.-,Twin.,Styled%20Components' target='_blank'>Refactoring Tailwind CSS React Apps with Twin.macro</AnchorLink></li>
          <li><AnchorLink href='https://blog.logrocket.com/intro-to-twin/' target='_blank'>Intro to Twin: Combining the best of Tailwind and CSS-in-JS</AnchorLink></li>
        </ul>
